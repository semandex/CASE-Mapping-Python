...
bundle = uco.core.Bundle(description="A new Case File")
investigation_items = []
...
# inv_act9.append_facets(action_ref9, device9)
...
email_address_1 = uco.observable.FacetEmailAddress(
    email_address_value="test@test.com", display_name="Tester Test"
)
...
email_address_2 = uco.observable.FacetEmailAddress(
    email_address_value="admin@test.com", display_name="A B"
)
...
identity_name = uco.identity.FacetSimpleName(
    given_name="Jones", family_name="Family-name"
)
...
phone_account_object2 = uco.observable.ObservableObject()
phone_account2 = uco.observable.FacetPhoneAccount(phone_number="654321")
phone_account_object2.append_facets(phone_account2)
bundle.append_to_uco_object(phone_account_object2)
